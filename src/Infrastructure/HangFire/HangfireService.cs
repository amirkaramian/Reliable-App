...
namespace MyReliableSite.Infrastructure.HangFire;
...
public class HangfireService : IJobService
{
    ...
    public void ScheduleRecurringJobOnDailyCron(Expression<Action> methodCall)
    {
        RecurringJob.AddOrUpdate(methodCall, Cron.Daily, TimeZoneInfo.Utc);
    }
}
