...
namespace Migrators.MSSQL.Migrations.Application
{
    ...
    [Migration("20220811222010_whmcsprodorder")]
    partial class whmcsprodorder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyReliableSite.Domain.Products.OrderTemplateCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OrderTemplateCategories");
                });

            modelBuilder.Entity("MyReliableSite.Domain.Products.OrderTemplateDepartments", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OrderTemplateDepartments");
                });
            ...
            modelBuilder.Entity("MyReliableSite.Domain.Products.OrderTemplateCategory", b =>
                {
                    ...
                    b.HasOne("MyReliableSite.Domain.Billing.OrderTemplate", "OrderTemplate")
                        .WithMany("OrderTemplateCategories")
                        .HasForeignKey("OrderTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyReliableSite.Domain.Products.OrderTemplateDepartments", b =>
                {
                    ...
                    b.HasOne("MyReliableSite.Domain.Billing.OrderTemplate", "OrderTemplate")
                        .WithMany("OrderTemplateDepartments")
                        .HasForeignKey("OrderTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyReliableSite.Domain.Billing.OrderTemplate", b =>
                {
                    b.Navigation("OrderTemplateCategories");

                    b.Navigation("OrderTemplateDepartments");
