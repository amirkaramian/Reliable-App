namespace MyReliableSite.Client.API.Extensions;
    ...
    public static ConfigureHostBuilder AddConfigurations(this ConfigureHostBuilder host)
    {
        host.ConfigureAppConfiguration((context, config) =>
        {
            ...
            config.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                ...
                .AddJsonFile($"{configurationsDirectory}/module-management.json", optional: false, reloadOnChange: true)
                ...
                .AddJsonFile($"{configurationsDirectory}/ip-rate-limiting.json", optional: true, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/client-rate-limiting.json", optional: true, reloadOnChange: true)
