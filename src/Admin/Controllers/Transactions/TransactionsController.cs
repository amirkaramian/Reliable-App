...
public class TransactionsController : BaseController
{
    ...
    [SwaggerHeader("tenant", "Transactions", "View", "Input your tenant to access this API i.e. admin for test", "admin", true)]
    ...
    [ProducesResponseType(500)]
    [SwaggerHeader("tenant", "Transactions", "Search", "Input your tenant to access this API i.e. admin for test", "admin", true)]
