...
using MyReliableSite.Admin.API.Extensions;
...
try
{
    ...
    builder.Services.AddInfrastructure(builder.Configuration, "Admin");
    builder.Services.AddControllers().AddFluentValidation();

    var app = builder.Build();

    app.UseInfrastructure(builder.Configuration, "Admin");
